...
##### for loop 在做的事  
就如同剛剛所說的，所有猜測值都是被存成四位數，所以我們先在此先生成所有四位數，在這裡我們使用到`stringstream`這個功能，你可以把它想成一個字串轉換的方式，他能夠將將字串轉成其他形別，或將其他型別的東西轉成字串，一個在 c++ 很實用的功能，詳情請看[ string stream reference](http://www.cplusplus.com/reference/sstream/stringstream/)  
